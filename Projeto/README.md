...
- Voyage history with stability results
- Google Sign-In
...
KB     = Draft / 2                          (waterplane centroid — rectangular section)
...
git clone https://github.com/YOUR_USERNAME/StabilityLoadingPlanner.git
cd StabilityLoadingPlanner
...
- [ ] **Google Sign-In** — Firebase Auth extra provider
